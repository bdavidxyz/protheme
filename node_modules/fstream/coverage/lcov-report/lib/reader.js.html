<!doctype html><html lang="en"><head><title>Code coverage report for lib/reader.js</title><meta charset="utf-8"><link rel="stylesheet" href="../prettify.css"><link rel="stylesheet" href="../base.css"><meta name="viewport" content="width=device-width, initial-scale=1"><style type="text/css">
        .coverage-summary .sorter {
            background-image: url(../sort-arrow-sprite.png);
        }
    </style></head><body><div class="wrapper"><div class="pad1"><h1><a href="../index.html">all files</a> / <a href="index.html">lib/</a> reader.js</h1><div class="clearfix"><div class="fl pad1y space-right2"><span class="strong">60.29%</span> <span class="quiet">Statements</span> <span class="fraction">82/136</span></div><div class="fl pad1y space-right2"><span class="strong">46.88%</span> <span class="quiet">Branches</span> <span class="fraction">45/96</span></div><div class="fl pad1y space-right2"><span class="strong">45.45%</span> <span class="quiet">Functions</span> <span class="fraction">5/11</span></div><div class="fl pad1y space-right2"><span class="strong">62.31%</span> <span class="quiet">Lines</span> <span class="fraction">81/130</span></div></div></div><div class="status-line medium"></div><pre><table class="coverage">
